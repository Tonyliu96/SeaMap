...
const dictionaries = {
  en: {
    ...
    "tide.waveSource": "Wave source",
    "tide.nearshorePoint": "Nearest MHL buoy: {name} ({id}), {distance} km away",
    "tide.windSpeed": "Wind speed",
    "tide.windDirection": "Wind direction",
    "tide.refresh": "Refresh tide",
    "tide.high": "High",
    "tide.low": "Low",
    "mhl.panelTitle": "MHL NSW Ocean Wave Data",
    "mhl.popupTitle": "NSW Wave Buoy",
    "mhl.clickHint": "Click the buoy to open the forecast table.",
    "mhl.loadError": "Unable to load MHL wave buoy data.",
    "mhl.forecastLoading": "Loading buoy forecast...",
    "mhl.forecastError": "Unable to load this buoy forecast.",
    "mhl.closePanel": "Close buoy forecast",
    "mhl.interval": "Interval",
    "mhl.day": "day",
    "mhl.today": "Today",
    "mhl.tomorrow": "Tomorrow",
    "mhl.time": "time",
    "mhl.wind": "wind",
    "mhl.windSource": "Wind source",
    "mhl.windModel": "Open-Meteo model",
    "mhl.swell": "swell",
    "mhl.temperature": "C",
    "mhl.waveHeight": "wave",
    "mhl.wavePeriod": "wave period",
    "mhl.tideMsl": "tide MSL",
    "mhl.waveDirection": "Wave direction",
    "mhl.latestWaveHeight": "Latest wave height",
    "mhl.latestWavePeriod": "Latest wave period",
    "mhl.latestWaveDirection": "Latest wave direction",
    "mhl.observedAt": "Observed",
    "mhl.disclaimer": "MHL buoy values are automatic observations and may not be quality controlled. Hourly wind, tide and forecast rows are modelled context and are not for navigation.",
  ...
  zh: {
    ...
    "tide.waveHeight": "浪高",
    "tide.wavePeriod": "浪周期",
    "tide.waveSource": "浪数据来源",
    "tide.nearshorePoint": "最近的 MHL 浮标：{name}（{id}），距离 {distance} km",
    "tide.windSpeed": "风速",
    "tide.windDirection": "风向",
    "tide.refresh": "刷新潮汐",
    "tide.high": "高潮",
    "tide.low": "低潮",
    "mhl.panelTitle": "MHL NSW 海浪数据",
    "mhl.popupTitle": "NSW 波浪浮标",
    "mhl.clickHint": "点击浮标打开下方预报表。",
    "mhl.loadError": "无法加载 MHL 波浪浮标数据。",
    "mhl.forecastLoading": "正在加载浮标预报...",
    "mhl.forecastError": "无法加载这个浮标的预报。",
    "mhl.closePanel": "关闭浮标预报",
    "mhl.interval": "时间间隔",
    "mhl.day": "日期",
    "mhl.today": "今天",
    "mhl.tomorrow": "明天",
    "mhl.time": "时间",
    "mhl.wind": "风",
    "mhl.windSource": "风数据来源",
    "mhl.windModel": "Open-Meteo 模型",
    "mhl.swell": "涌浪",
    "mhl.temperature": "C",
    "mhl.waveHeight": "浪高",
    "mhl.wavePeriod": "浪周期",
    "mhl.tideMsl": "潮位 MSL",
    "mhl.waveDirection": "浪向",
    "mhl.latestWaveHeight": "最新浪高",
    "mhl.latestWavePeriod": "最新浪周期",
    "mhl.latestWaveDirection": "最新浪向",
    "mhl.observedAt": "观测时间",
    "mhl.disclaimer": "MHL 浮标值为自动观测数据，可能未经过质量控制。小时风、潮位和预报行是模型参考数据，不可用于航海导航。",
    "map.center": "地图中心",
